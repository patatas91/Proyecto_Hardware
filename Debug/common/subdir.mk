...
common/%.o: ../common/%.asm
	...
	arm-none-eabi-gcc -x assembler-with-cpp -I"C:\Users\guest\WORKSPACE\p2\common" -Wall -Wa,-adhlns="$@.lst" -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -mcpu=arm7tdmi -g3 -gdwarf-2 -o "$@" "$<"
