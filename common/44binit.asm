...
exception:
	...
	sub r1, lr, #4
	BL push_debug	// apilamos la excepcion

	BL error	// mostrar excepcion
...
.equ 	DebugStack,	_ISR_STARTADDRESS-0xf00			/*c7ff000   Direccion de inicio de la pila de debug  */
.equ 	UserStack,	_ISR_STARTADDRESS-0xf00-12*20   /* c7fedc0 */
